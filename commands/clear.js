module.exports = {
    name: 'clear',
    description: "Purges and amount of messages in a text channel",
    async execute(message, args){
        if(message.member.hasPermission("MANAGE_MESSAGES")){
            ...
            message.channel.send("You couldn't clear. Do you or I have the permissions `MANAGE_MESSAGES`? If not, add them!");
        }
    }
}